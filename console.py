...
class HBNBCommand(cmd.Cmd):
    ...
    def do_quit(self, line):
        """QuitCommand to exit the program."""
        return True
    ...
    def do_create(self, line):
        """CreateCommand to create new User."""
    ...
    def do_show(self, line):
        """ShowCommand to show an instance based on class name and id."""
        if not line:
            print("** class name missing **")
    ...
    def do_destroy(self, line):
        """DeleteCommand to delete an instance based on class name and id."""
        splitline = split(line)
    ...
    def do_all(self, line):
        """AllCommand to print all instances based or not class name"""
        str_list = []
    ...
    def do_update(self, line):
        """UpdateCommand to update an instance base on class name and id"""
        splitline = split(line)
    ...
    def default(self, line):
        """Parses and interpretates a line if not found on regular commands"""
        count = 0
